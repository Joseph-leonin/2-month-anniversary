    ...
    <div className="min-h-screen w-full bg-black/20 flex flex-col items-center justify-center">
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className='w-[90%] max-w-[400px]'>
          <p className="z-10 text-white text-center text-x font-semibold px-4 drop-shadow-lg">
            Happy Valentines and 2nd Monthversary to us!
            Looking forward to our 100th Valentine Celebration together (i'm never letting you go). 
            I hope you enjoyed this little gift. I love you!!! ᡣ𐭩
